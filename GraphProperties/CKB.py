...
youtube = {
    ...
    "c_max" : 3001,
    "beta_2" : 2.13,
    "output_file" : "data/cbk_youtube.dat",
}
...
amazon = {
    ...
    "c_max" : 53551,
    "beta_2" : 2.02,
    "output_file" : "data/cbk_amazon.dat",
}


for n, nout, x_min, x_max, beta_1, c_min, c_max, beta_2, output_file in [list(youtube.values()), list(dblp.values()), list(amazon.values())]:
